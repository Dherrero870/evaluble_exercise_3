...
class SeismicAnalyzer:
    ...
    def load_data(self):
        ...
        self.data = pd.read_csv("https://digital.csic.es/bitstream/10261/284662/3/GEoREST_induced_seismicity_database_v20.11.2022.csv")
    ...
    def calculate_probabilities(self, region_name, start_date, end_date):
        ...
        region_data = self.data[(self.data['latitude'] >= self.region_data.loc[region_name, 'latitude_min']) &
                                ...
                                (self.data['longitude'] <= self.region_data.loc[region_name])]
...
def main():
    ...
    seismic_data = pd.read_csv("https://digital.csic.es/bitstream/10261/284662/3/GEoREST_induced_seismicity_database_v20.11.2022.csv")
